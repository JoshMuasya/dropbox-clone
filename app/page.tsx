  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-9">
      ...
      <p className="text-center font-light p-2">
        This is a Dropbox Clone for information and eductational purposes only
      </p>
    </main>
  )
}
